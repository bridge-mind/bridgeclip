...
test('network policy rejects private literals and private DNS results', async () => {
  ...
  assert.equal(policy.isPublicAddress('2001:4860:4828:400::'), true)
  for (const address of ['2001::1', '2001:0:4136:e378::1', '2001:db8::1', '2002:c000:0204::1']) assert.equal(policy.isPublicAddress(address), false)
